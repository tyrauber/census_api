...
describe CensusApi::Client do
  ...
  it 'should initialize with an api_key' do
    @client = CensusApi::Client.new(api_key: api_key)
    @client.api_key.should == api_key
  end

  it 'should initialize with an api_key and dataset' do
    dataset = 'SF1'
    @client = CensusApi::Client.new(api_key: api_key, dataset: dataset)
    @client.api_key.should == api_key
  ...
  it 'should request sf1' do
    ...
    @client = CensusApi::Client.new(api_key: api_key, dataset: source)
